...
+---------------------+--------------------------------------------------------+------+
| OS                  | Download Version                                       | Size |
+=====================+========================================================+======+
| Windows 10/8/7      | [RStudio-1.4.894.exe](%3Chttp://bit.ly/win-dl-rs)      | 157M |
+---------------------+--------------------------------------------------------+------+
| MacOS 10.13+        | [RStudio-1.4.895.dmg](http://bit.ly/mac-dl-rs)         | 154M |
+---------------------+--------------------------------------------------------+------+
| Ubuntu 18/Debian 10 | [rstudio-1.4.895-amd64.deb](http://bit.ly/ub-dl-rs)    | 115M |
+---------------------+--------------------------------------------------------+------+
| Fedora 28/RedHat 8  | [rstudio-1.4.895-x86\_64.rpm](http://bit.ly/fed-dl-rs) | 132M |
+---------------------+--------------------------------------------------------+------+
...
Markdown documents can be edited in either source or visual m ![](images/paste-F6E84BB0.png){width="13" height="12"} button at the top-right of the document toolbar (or alternatively the `⌘ + ⇧ + F12` keyboard shortcut):
